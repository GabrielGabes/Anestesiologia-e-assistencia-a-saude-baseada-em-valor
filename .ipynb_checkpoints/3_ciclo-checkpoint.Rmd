...
df = df_back_up %>% filter(grau_familiaridade2 != '2_prefere_nao_dizer')
df$grau_familiaridade2 = df$grau_familiaridade2 %>% factor(labels = c("0_conhece_o_tema","1_nconhece_o_tema"))
coluna_analisada = 'grau_familiaridade2'

lista_coluna = names(df)[which(!(names(df) %in% c(coluna_analisada,'grau_familiaridade','quando_parou')))]
